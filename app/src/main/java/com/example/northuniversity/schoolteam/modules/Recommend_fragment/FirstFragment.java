...
//        实现懒加载
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        show_recommend("Freshman");
        recommendContestadpater = new RecommendContestAdapter(nameList, contentList, startTimeList, endTimeList, fileList, getContext());
        ...
        recyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        recommendContestadpater.setData(nameList,startTimeList,endTimeList,contentList,fileList);
                        recommendContestadpater.notifyDataSetChanged();
    ...
    public void initView() {
        recyclerView = getActivity().findViewById(R.id.first_rv);
    }
            ...
            if (message.what == 2) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        name.add(jsonObject.getString("pk"));
                        JSONObject jsonObject1 = jsonObject.getJSONObject("fields");
                        startTime.add(jsonObject1.getString("sign_up_time"));
                        endTime.add(jsonObject1.getString("deadline"));
                        content.add(jsonObject1.getString("context"));
                        file.add(jsonObject1.getString("file"));
                    }
                    nameList = name;
